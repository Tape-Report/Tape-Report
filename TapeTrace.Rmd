...
# fviz_nbclust(data[2:16], kmeans, nstart = 50, method = "gap_stat", nboot = 50, k.max = 21)
# 
# k <- kmeans(mds, 14, nstart =100)
# 
# row.names(data) <- c(seq(1, 6), seq(8, 23))
# fviz_cluster(k, data = data[2:16])
...
pheatmap(data[,2:16], display_numbers = TRUE, clustering_distance_rows=gower_samples,
